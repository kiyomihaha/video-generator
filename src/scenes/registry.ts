  ...
  ChipIOVideo: {
    ...
    shell: {
      ...
      subtitles: [
        ...
        { startFrame: 3420, endFrame: 3680, text: "OE=1 时，输出驱动器连接 Pad，传递 DATA 信号" },
        { startFrame: 3680, endFrame: 3940, text: "DATA 切换：PMOS 或 NMOS 交替导通" },
        { startFrame: 3940, endFrame: 4200, text: "OE=0 → 上拉下拉都断开，引脚进入高阻态 Z" },
