  ...
  ChipIOVideo: {
    ...
    shell: {
      ...
      subtitles: [
        ...
        { startFrame: 300, endFrame: 594, text: "为什么不能直接连到引脚？", fadeOutEndFrame: 576 },
        // Segment 2: 12.16s (594→1342)
        { startFrame: 594, endFrame: 960, text: "芯片要连接按键、传感器、存储器、显示屏和其他芯片。" },
        { startFrame: 960, endFrame: 1342, text: "真正完成连接的，是一整套 I/O 接口电路。", fadeOutEndFrame: 1324 },
        // Segment 3: 20.48s (1342→2589)
        // Waveforms at y=520-590. Move subtitles above waveforms (y=460).
        { startFrame: 1342, endFrame: 1640, text: "芯片核心可能工作在 0.8 伏，", y: 460 },
        { startFrame: 1640, endFrame: 1940, text: "但外部接口可能是 1.8 伏或 3.3 伏。", y: 460 },
        { startFrame: 1940, endFrame: 2260, text: "核心晶体管驱动能力弱，也承受不了外部静电。", y: 460 },
        { startFrame: 2260, endFrame: 2589, text: "所以 I/O 必须完成电平适配、信号整形、功率驱动和保护。", y: 460 },
        ...
        { startFrame: 3300, endFrame: 3605, text: "转换成内部明确的 0 或 1。", fadeOutEndFrame: 3587 },
        ...
        { startFrame: 4370, endFrame: 4756, text: "推动 PCB 走线、连接器或者其他芯片的输入电容。", fadeOutEndFrame: 4738 },
        ...
        { startFrame: 5736, endFrame: 5897, text: "它既不输出零，也不输出一，相当于暂时退出总线。", fadeOutEndFrame: 5879 },
        ...
        { startFrame: 6640, endFrame: 7000, text: "ESD 钳位电路会优先把这股能量导向电源或地，保护核心器件。", fadeOutEndFrame: 6982 },
        ...
        { startFrame: 7620, endFrame: 7930, text: "电平不兼容、驱动不足、过冲振铃、总线争用、ESD 保护缺失，以及串扰噪声。", fadeOutEndFrame: 7912 },
