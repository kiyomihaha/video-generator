  ...
  ChipIOVideo: {
    ...
    shell: {
      ...
      subtitles: [
        ...
        { startFrame: 300, endFrame: 594, text: "为什么不能直接连到引脚？", fadeOutEndFrame: 594 },
        // Segment 2: 12.16s (594→1342)
        { startFrame: 594, endFrame: 960, text: "芯片要连接按键、传感器、存储器、显示屏和其他芯片。" },
        { startFrame: 960, endFrame: 1342, text: "真正完成连接的，是一整套 I/O 接口电路。", fadeOutEndFrame: 1342 },
        // Segment 3: 20.48s (1342→2589)
        // Waveforms start at ~1942 (segment frame 600). Subtitles end before waveforms.
        { startFrame: 1342, endFrame: 1640, text: "芯片核心可能工作在 0.8 伏，" },
        { startFrame: 1640, endFrame: 1920, text: "但外部接口可能是 1.8 伏或 3.3 伏。", fadeOutEndFrame: 1920 },
        // No subtitles during waveform display (1920-2589)
        ...
        { startFrame: 3300, endFrame: 3605, text: "转换成内部明确的 0 或 1。", fadeOutEndFrame: 3605 },
        ...
        { startFrame: 4370, endFrame: 4756, text: "推动 PCB 走线、连接器或者其他芯片的输入电容。", fadeOutEndFrame: 4756 },
        ...
        { startFrame: 5736, endFrame: 5897, text: "它既不输出零，也不输出一，相当于暂时退出总线。", fadeOutEndFrame: 5897 },
        ...
        { startFrame: 6640, endFrame: 7000, text: "ESD 钳位电路会优先把这股能量导向电源或地，保护核心器件。", fadeOutEndFrame: 7000 },
        ...
        { startFrame: 7620, endFrame: 7930, text: "电平不兼容、驱动不足、过冲振铃、总线争用、ESD 保护缺失，以及串扰噪声。", fadeOutEndFrame: 7930 },
        ...
        { startFrame: 8500, endFrame: 8850, text: "输入输出单元，才是数字逻辑真正连接物理世界的边界。", fadeOutEndFrame: 8850 },
      ],
    },
  },
};
