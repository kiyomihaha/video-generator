...
const inputIOSpec: CircuitWaveformLinkerAuthoring = {
  ...
  framesPerCycle: 100,
  zones: [
    { id: "ext",  label: "External\nSignal",   x: 40,  y: 290, width: 130, height: 90 },
    { id: "pad",  label: "Pad",                 x: 200, y: 290, width: 110, height: 90 },
    { id: "esd",  label: "ESD",                 x: 340, y: 290, width: 100, height: 90 },
    { id: "buf",  label: "Input\nBuffer",       x: 470, y: 290, width: 130, height: 90 },
    { id: "sch",  label: "Schmitt\nTrigger",    x: 630, y: 290, width: 140, height: 90 },
    { id: "sync", label: "Synchronizer",        x: 800, y: 290, width: 140, height: 90 },
    { id: "core", label: "Core",                x: 970, y: 290, width: 110, height: 90 },
  ],
  links: [
